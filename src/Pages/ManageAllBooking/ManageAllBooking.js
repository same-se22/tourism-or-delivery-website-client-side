...
const ManageAllBooking = () => {
  ...
  useEffect(() => {
    fetch("https://peaceful-forest-00600.herokuapp.com/allOrders")
      .then((res) => res.json())
  ...
  const deleteOrders = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://peaceful-forest-00600.herokuapp.com/deleteOrders/${id}`, {
          method: "DELETE",
  ...
  const approveOrders = (id) => {
    fetch(`https://peaceful-forest-00600.herokuapp.com/update/${id}`, {
      method: "PUT",
      headers: {
            ...
            <div className="row g-0">
              ...
              <div className="col-md-6">
                <div className="py-2">
                  ...
                  <p className="m-0 text-white">your email : {order.email}</p>
                  <h6 className="m-0 text-white">Tour Destination : {order.item.title}</h6>
